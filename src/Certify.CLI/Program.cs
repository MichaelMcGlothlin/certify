...
namespace Certify.CLI {
 internal class Program {
  ...
  private Boolean PerformCertRequestAndIISBinding ( String certDomain ) {
   ...
   if ( identiferStatus.Authorization.Status != "valid" ) {
    ...
    if ( certDetails != null && !String.IsNullOrEmpty ( certDetails.IssuerSerialNumber ) ) {
     ...
     var certFolderPath = vaultManager.GetCertificateFilePath ( certDetails.Id, LocalDiskVault.ASSET );
