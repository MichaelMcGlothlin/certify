...
namespace Certify.Management {
 ...
 public class IISManager {
  ...
  public IEnumerable<Site> GetSites ( ServerManager iisManager, Boolean includeOnlyStartedSites ) => includeOnlyStartedSites
  ...
  /// <returns></returns>
  public List<SiteBindingItem> GetPrimarySites ( Boolean includeOnlyStartedSites ) {
  ...
  public List<SiteBindingItem> GetSiteBindingList ( Boolean includeOnlyStartedSites ) {
   var result = new List<SiteBindingItem> ();
   try {
    using ( var iisManager = new ServerManager () ) {
     var sites = GetSites ( iisManager, includeOnlyStartedSites );
