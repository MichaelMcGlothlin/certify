...
namespace ACMESharp.POSH.Util {
 public static class PoshHelper {
  static PoshHelper () {
   ...
   ExtCommon.RelativeSearchPathOverride = System.String.Empty;
  }
  ...
  /// </summary>
  public const System.String PROBLEM_DETAIL_TYPE_URN = "urn:acme:error:";
  ...
  /// </remarks>
  public static readonly ReadOnlyDictionary<System.String, ErrorCategory> PROBLEM_DETAIL_TYPE_TO_ERROR_CATEGORY =
          new ReadOnlyDictionary<System.String, ErrorCategory> ( new Dictionary<System.String, ErrorCategory> {
  ...
  /// <returns></returns>
  public static ErrorRecord CreateErrorRecord ( AcmeClient.AcmeWebException ex, System.Object targetObject = null ) {
   // Resolve Error ID
   var errorId = "(n/a)";
   if ( (System.Boolean) ex.Data?.Contains ( nameof ( errorId ) ) ) {
    errorId = ex.Data[ nameof ( errorId ) ] as System.String;
   ...
   if ( (System.Boolean) ex.Data?.Contains ( nameof ( errorCategory ) ) ) {
   ...
   if ( !System.String.IsNullOrEmpty ( ex.Response?.ProblemDetail?.Detail ) ) {
