...
namespace ACMESharp.POSH {
 ...
 public class CompleteChallenge : Cmdlet {
  ...
  public String HandlerProfileRef { get; set; }
  ...
  /// </summary>
  [Parameter]
  public Hashtable HandlerParameters { get; set; }
  ...
  /// </summary>
  [Parameter]
  public SwitchParameter UseBaseUri { get; set; }
  ...
  protected override void ProcessRecord () {
   using ( var vlt = Util.VaultHelper.GetVault ( VaultProfile ) ) {
    ...
    ii.Challenges = ii.Challenges ?? new Dictionary<String, AuthorizeChallenge> ();

    ii.ChallengeCompleted = ii.ChallengeCompleted ?? new Dictionary<String, DateTime?> ();

    ii.ChallengeCleanedUp = ii.ChallengeCleanedUp ?? new Dictionary<String, DateTime?> ();
    ...
    ii.Challenges.TryGetValue ( challengeType, out var challenge );
    ii.ChallengeCompleted.TryGetValue ( challengeType, out var challengeCompleted );
    ii.ChallengeCleanedUp.TryGetValue ( challengeType, out var challengeCleanedUp );
