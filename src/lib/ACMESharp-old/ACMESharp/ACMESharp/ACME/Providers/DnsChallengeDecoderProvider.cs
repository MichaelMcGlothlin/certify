...
namespace ACMESharp.ACME.Providers {
 ...
 public class DnsChallengeDecoderProvider : IChallengeDecoderProvider {
  public System.Boolean IsSupported ( IdentifierPart ip, ChallengePart cp ) => AcmeProtocol.CHALLENGE_TYPE_DNS == cp.Type;

  public IChallengeDecoder GetDecoder ( IdentifierPart ip, ChallengePart cp ) => new DnsChallengeDecoder ();
 }
}