...
namespace ACMESharp.JOSE {
 ...
 public static class JwsHelper {
  ...
  public static JwsSigned SignFlatJsonAsObject ( Func<Byte[], Byte[]> sigFunc, String payload,
   ...
   var payloadB64u = Base64UrlEncode ( Encoding.UTF8.GetBytes ( payload ) );
   var protectedB64u = Base64UrlEncode ( Encoding.UTF8.GetBytes ( protectedHeadersSer ) );
   ...
   var sigB64u = Base64UrlEncode ( sigBytes );
