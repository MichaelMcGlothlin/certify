...
namespace ACMESharp {
 public class AuthorizeChallenge {
  ...
  public ChallengePart ChallengePart { get; set; }
  ...
  public KeyValuePair<String, String> OldChallengeAnswer { get; set; }

  public Object ChallengeAnswerMessage { get; set; }

  public String HandlerName { get; set; }

  public DateTime? HandlerHandleDate { get; set; }

  public DateTime? HandlerCleanUpDate { get; set; }

  public DateTime? SubmitDate { get; set; }

  public Object SubmitResponse { get; set; }
  ...
  public Boolean IsInvalid () => String.Equals ( Status, STATUS_INVALID,
           StringComparison.InvariantCultureIgnoreCase );
